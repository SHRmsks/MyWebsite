          ...
          >
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 font-slant text-[14px] text-[#05d9e8]">
                  {job.org}{" "}
                  <span className="text-[#7d97a0] font-cyberpunk">
                    · {job.place}
                  </span>
                </p>
                <ul className="mt-3 flex flex-col gap-2">
                  {job.bullets.map((b, j) => (
                    <li
                      key={j}
                      className="flex gap-2 font-text text-[13px] leading-[1.6] text-[#bcd6d0]"
                    >
